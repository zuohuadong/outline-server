...
export class ServerManagementApp {
    ...
    constructor(
      ...
      private surveys: Surveys) {
        ...
        appRoot.addEventListener('SetAccessKeyDataLimitRequested', (event: CustomEvent) => {
            this.setAccessKeyDataLimit(ServerManagementApp.displayDataAmountToDataLimit(event.detail.limit));
        });
    ...
    public async showServer(selectedServer: server.Server, selectedDisplayServer: DisplayServer) {
        ...
        view.serverCreationDate = ServerManagementApp.localizeDate(selectedServer.getCreatedDate(), this.appRoot.language);
        ...
        view.accessKeyDataLimit = ServerManagementApp.dataLimitToDisplayDataAmount(selectedServer.getAccessKeyDataLimit());
        ...
        try {
            ...
            if (!view.accessKeyDataLimit) {
                view.accessKeyDataLimit = ServerManagementApp.dataLimitToDisplayDataAmount(
                  await ServerManagementApp.computeDefaultAccessKeyDataLimit(selectedServer, serverAccessKeys));
            }
    ...
    private async setAccessKeyDataLimit(limit: server.DataLimit) {
        ...
        try {
            ...
            serverView.accessKeyDataLimit = ServerManagementApp.dataLimitToDisplayDataAmount(
              previousLimit || await ServerManagementApp.computeDefaultAccessKeyDataLimit(this.selectedServer));
    ...
    private static displayDataAmountToDataLimit(dataAmount: DisplayDataAmount): server.DataLimit|null {
        if (!dataAmount) {
            return null;
        }
